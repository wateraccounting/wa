...
def Fraction_Based(Name_NC_Parameter, Name_NC_LU, Startdate, Enddate):
    """
    ...
    DataCube_Parameter = RC.Open_nc_array(Name_NC_Parameter, Var = None, Startdate = Startdate, Enddate = Enddate)
