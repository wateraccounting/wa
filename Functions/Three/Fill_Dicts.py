...
def Crop_Dictionaries(wp_y_irrigated_dictionary, wp_y_rainfed_dictionary, dict_crops, Name_NC_LU, Name_NC_ETgreen, Name_NC_ETblue, Name_NC_NDM, Name_NC_P, output_dir):    
    ...
    # open LULC map
    LULC_Array = RC.Open_nc_array(Name_NC_LU)
    ...
    for crop in dict_crops['crops']:
        ...
        if crop[4] in LULC_Array:
            ...
            result_seasonly = Three.Calc_Y_WP.Seasons(start_dates, end_dates, Name_NC_LU, crop[4], crop[1], Name_NC_ETgreen, Name_NC_ETblue, Name_NC_NDM, Name_NC_P, output_dir, ab = (1.0,0.9))
