...
def Calculate(Basin, P_Product, ET_Product, Moving_Averaging_Length, Startdate, Enddate, Simulation):
    ...
    Startdate_Moving_Average_String = '%d-%02d-%d' %(Startdate_Moving_Average.year, Startdate_Moving_Average.month, Startdate_Moving_Average.day)
    Enddate_Moving_Average_String = '%d-%02d-%d' %(Enddate_Moving_Average.year, Enddate_Moving_Average.month, Enddate_Moving_Average.day)
