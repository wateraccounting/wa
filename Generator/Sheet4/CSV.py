...
def Create(Dir_Basin, Simulation, Basin, Startdate, Enddate, Name_NC_LU, Name_NC_Total_Supply_GW, Name_NC_Total_Supply_SW, Name_NC_Non_Consumed, Name_NC_Consumed_ET, Name_NC_RecovableFlow_Return_GW, Name_NC_RecovableFlow_Return_SW, Name_NC_NonRecovableFlow_Return_GW, Name_NC_NonRecovableFlow_Return_SW):
    """
    ...
    Data_Path_CSV = os.path.join(Dir_Basin, "Simulations", "Simulation_%d" %Simulation, "Sheet_4", "CSV")
    ...
    DataCube_Total_Supply_GW = RC.Open_nc_array(Name_NC_Total_Supply_GW, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_Total_Supply_SW = RC.Open_nc_array(Name_NC_Total_Supply_SW, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_Consumed_ET = RC.Open_nc_array(Name_NC_Consumed_ET, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_Non_Consumed = RC.Open_nc_array(Name_NC_Non_Consumed, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_RecovableFlow_Return_GW = RC.Open_nc_array(Name_NC_RecovableFlow_Return_GW, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_RecovableFlow_Return_SW = RC.Open_nc_array(Name_NC_RecovableFlow_Return_SW, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_NonRecovableFlow_Return_GW = RC.Open_nc_array(Name_NC_NonRecovableFlow_Return_GW, Var = None, Startdate = Startdate, Enddate = Enddate)
    DataCube_NonRecovableFlow_Return_SW = RC.Open_nc_array(Name_NC_NonRecovableFlow_Return_SW, Var = None, Startdate = Startdate, Enddate = Enddate)
